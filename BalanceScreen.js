...
let maxpoints =10000
  ...
  const setBadge = () => {
    if (number > 0 && number < 4000) {
      return <Badge1/> 
    } else if (number < 7000 && number > 3999) {
      return <Badge2 />
    } else {
      return <Badge3 />
    }
      ...
      <TouchableOpacity activeOpacity={0.8}>
        <View style={style.cardTop}>
          ...
          <View style={{ width: '70%', paddingTop: '20%' }}>
            <Text
              style={{ fontWeight: 'bold', color: "#2eda84", fontSize: 35 }}>
              {number}
            </Text>
    ...
    return (
      ...
      <SafeAreaView>
        <ScrollView>
          <View>
            <Text>    </Text>
            <Text style={{ fontWeight: 'bold', color: "#5e2590", fontSize: 30 }}> Greetings Sara!</Text>
